...
public class AgentObserver : MonoBehaviour
{
    ...
    /// </summary>
    private List<(GizmosTag, Vector3)> wallsAndObjectivesGizmos = new List<(GizmosTag, Vector3)>();
    ...
    /// </summary>
    public List<(GizmosTag, Vector3)> WallsAndObjectivesGizmos { get => wallsAndObjectivesGizmos; set => wallsAndObjectivesGizmos = value; }
        ...
        foreach (RaycastHit observation in results)
        {
            ...
            switch (objTag)
            {
                ...
                case Tag.Agent:
                    ...
                    normalizedDistance = observation.distance / MyConstants.MAXIMUM_VIEW_OTHER_AGENTS_DISTANCE;
                    break;
                default:
