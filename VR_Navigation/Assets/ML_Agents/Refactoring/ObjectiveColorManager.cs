...
public class ObjectiveColorManager : MonoBehaviour
{
    ...
    /// </summary>
    private Dictionary<GameObject, List<RLAgent>> objectiveToAgents = 
        new Dictionary<GameObject, List<RLAgent>>();
    ...
    public void RegisterAgentObjectives(RLAgent agent, List<GameObject> objectives)
    {
        foreach (GameObject objective in objectives)
        {
            ...
            {
                objectiveToAgents[objective] = new List<RLAgent>();
            }
    ...
    public void UpdateObjectiveColors()
    {
        ...
        foreach (Transform t in allTransforms)
        {
            if (t.CompareTag("Obiettivo"))
            {
                ...
                if (objectiveToAgents.ContainsKey(objective))
                {
                    List<RLAgent> assignedAgents = objectiveToAgents[objective];
    ...
    private bool AllAgentsSameGroup(List<RLAgent> agents)
    {
